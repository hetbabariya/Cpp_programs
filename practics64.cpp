/*
    18.Design a class called MatrixCalculator with member variables for two matrices and their dimensions. Include functions to add, 
    subtract, and multiply the matrices. Instantiate a MatrixCalculator object, perform matrix operations, and print the results.
*/
    ...
    void sub(Matrix &other)
    {
      ...
      { 
        ...
        for(int i = 0 ; i < r1 ; i++)
        {
          ...
          // output
          cout << endl << "Subraction is : " << endl << endl;
          display(r1,c1);
      }
      else
      {
        cout << "\nNot able to Subraction..." << endl;
      }
